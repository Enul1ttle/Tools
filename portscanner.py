...
# Author: TheBaconator
# Thanks to Mansoor at digitz.org for some of the help!
...
desc = line+'''\nThis port scanner is for educational purposes only and should only
        be used on systems that you have permission to scan on. I am not responsible 
        for any misuse of this port scanner. Happy Scanning!
